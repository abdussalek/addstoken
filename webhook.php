...
$apiKey = '7753131996:AAH2KqaAbTK0Uywv463Jti6HF5dxXkef4K0'; // Your Telegram bot API key
...
if ($text === '/start') {
    ...
    $post_fields = [
        ...
        'reply_markup' => json_encode([
            'inline_keyboard' => [
                [
                    ['text' => 'Play GamaDog Now', 'web_app' => ['url' => 'https://fluffy-smakager-d1f4e2.netlify.app']],
